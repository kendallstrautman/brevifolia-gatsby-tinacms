...
Brevifolia is minimalist blog starter to get you going using [TinaCMS](https://tinacms.org) with [Gatsby](https://www.gatsbyjs.org/). TODO!!! update the demo ---> Check out the [Forestry](https://forestry.io) version of the demo [here](https://brevifolia-gatsby-forestry.netlify.com/).
